...
./src/nginx_exporter --nginx.scrape-uri http://$nginx_host:$nginx_status_port$nginx_status_uri --web.listen-address=$exporter_host:$exporter_port --web.telemetry-path=$exporter_uri >/dev/null 2>$LOG_FILE &
# 获得执行的pid
echo $!